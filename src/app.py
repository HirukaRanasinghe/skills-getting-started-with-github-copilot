...
activities = {
    ...
    "Drama Club": {
        "description": "Act, perform, and build confidence on stage",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["emily@mergington.edu", "ethan@mergington.edu"]
    },
    "Math Club": {
    ...
    "Science Club": {
        "description": "Investigate experiments and discover how the world works",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
